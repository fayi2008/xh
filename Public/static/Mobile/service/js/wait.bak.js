$(function () {
    ...
    function _wait() {
        ...
        function init(page) {
            ...
            $.ajax({
                url: "/poi/receive/lists?page=" + page,
                dataType: "json",
                type: "get"
            }).done(function (rs) {
