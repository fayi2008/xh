...
;(function(){
    ...
    Combo.prototype = {
        ...
        ctor:function(){
            ...
            this.tips = P.dom.create('div',null,'p-tips','',this.el);
            this.tips_toggle = P.dom.create('a',null,'p-tips-toggle','',this.tips);
            this.tips_main = P.dom.create('div',null,'p-tips-main','',this.tips);
            P.dom.create('i',null,'','',this.tips_toggle);
            var map_id = 'map_container'+ "_" + new Date().getTime() + "_" +Math.round(Math.random()*300);
            var map_el = P.dom.create('div','','p-nav-map','',this.album);
            this.map_container = P.dom.create('div',map_id,'','width:100%;height:100%;',map_el);
            this.map_toggle = P.dom.create('a','','p-map-toggle','',map_el);

            var cat = P.dom.create('div','','cat','',map_el);
            cat.innerHTML = '<h3>全部</h3><ul style="display:none;"><li data-id="" class="select">全部</li><li data-id="2">景点</li><li data-id="1">商户</li><li data-id="3">公共设施</li><li data-id="4">厕所</li><li data-id="5">空中全景</li></ul>';
            ...
            this.pano.whenReady(function(){
                if(window.BMap){
                    ...
                    if(this.options.mapReady){
                        this.options.mapReady(this.map);
                    }
                }
        ...
        onChanged : function(){
            ...
            if(panoData.poi_data){
                this.tips_main.innerHTML = panoData.poi_data.description;
            }
