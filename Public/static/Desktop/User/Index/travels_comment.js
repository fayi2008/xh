        ...
        function view(rs) {
            if (rs.data && rs.data.length) {
                ...
                for (var i in rs.data) {
                    var datas = rs.data[i];
                    //var img = $(datas.t_content).find("img").length ? $(datas.t_content).find("img").attr("src") :"/static/Desktop/Img/img.png";
                    var img = datas.thumb ?( '/upload/'+datas.thumb) :"/static/Desktop/Img/img.png";
                    ...
                    html += '<a class="comment-travels-author-title" href="/travels/' + datas.module_id + '.html">' + datas.title + "</a>";
                    html += '<div class="comment-travels-author-tools">';
                    html += '<div class="comment-travels-author-name">作者：' + datas.nickname + "</div>";
