...
!function () {
    ...
    var t = (P.BLEND = {
        ...
        _initEvents: function (t) {
            ...
            var e = this;
            id = t.id, window["__P_hook_" + id] = this, t.set("control.mousetype", "drag2d"), t.set("events.onclick", this.opa("click")), t.set("events.onmousedown", this.opa("mousedown")), t.set("events.onmouseup", this.opa("mouseup")), t.set("events.onnewpano", this.opa("pano_changed")), t.set("events.onviewchanged", this.opa("pov_changed")), t.set("events.onxmlcomplete", this.opa("ready")), t.addEventListener ? t.addEventListener("mousemove", function (t) {
                e._exec(t.type)
        ...
        _exec: function (t, e) {
            ...
            }) : "overlay_click" == t || "overlay_mouseup" == t || "overlay_mousedown" == t ? o._overlays[e] && (o.trigger(t, {target: o._overlays[e]}), o._overlays[e].trigger(t.replace("overlay_", ""), {target: o._overlays[e]})) : "ready" == t ? o.__ready__ || (o.__ready__ = !0, o.trigger(t, {target: o})) : o.trigger(t, {target: o})
        },
