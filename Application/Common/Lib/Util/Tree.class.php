...
class Tree {
	 ...
	 */
	function get_treeview_menu($myid, $effected_id = 'dnd-example', $str = "", $str2 = "", $showlevel = 0, $ul_class = "", $li_class = "", $style = 'filetree ', $currentlevel = 1, $recursion = FALSE, $dropdown = 'hasChild') {
		$child = $this->get_child($myid);
		if (!defined('EFFECTED_INIT')) {
			$effected = ' id="' . $effected_id . '"';
			define('EFFECTED_INIT', 1);
	...
	/**
	 * asdfasffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
	 * asdfasffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
	 * asdfasffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
	 * asdfasffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
	 * asdfasffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
	 ...
	 * @author mike
	 */
	function get_smart_treeview_menu($myid, $str1 = "",$str2 = "" ) {
		$this->str .='<ul>';
		$child = $this->get_child($myid);
		$placeholder = '</li>';
		foreach ($child as $id => $a) {
			...
			if ($this->get_child($a['id'])) {
				...
				$this->str .= $nstr;
				//$this->str .=$placeholder;
				$this->get_smart_treeview_menu($a['id'], $str1,$str2);
			} else {
