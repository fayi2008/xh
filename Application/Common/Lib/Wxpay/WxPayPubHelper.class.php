...
class Common_util_pub
{
	...
	public function getSign($Obj)
	{
		...
		//签名步骤二：在string后加入KEY
		$String = $String."&key=".$this->wx_config['KEY'];
...
{	
	...
	function __construct($wx_config=array()) 
	{
		$this->wx_config = array_merge(C('WXPAY'),$wx_config);
		//设置接口链接
